...
use sys::vxworks::ext::ffi::OsStrExt;
use fmt;
...
use sys::{cvt, cvt_r, unsupported};
use sys_common::{AsInner, FromInner};
use libc::{self, c_int, mode_t, stat, off_t, ftruncate, lseek, dirent, readdir_r as readdir64_r, open};
...
impl FileAttr {
    ...
    pub fn created(&self) -> io::Result<SystemTime> {
        Err(io::Error::new(io::ErrorKind::Other, "creation time is not available on this platform currently"))
    }
...
impl ::sys_common::FromInner<c_int> for File {
...
// This whole function is not supported, because file links are not supported in vxworks
